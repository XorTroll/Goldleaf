...
namespace gleaf::set
{
	...
	static const Dictionary French =
    {
        Language::French,
        {
            ...
            "Voir les information de la console",
            ...
            "PRODINFOF contiens plusieurs fichiers journaux de tests et autres contenus.",
            ...
            "Sélectionnez une page web a parcourir à travers l'applet web.",
            "La page sélectionnez n'est pas formatée correctement.",
            "Une erreur est apparu en essayant de lancer l'applet web:",
            ...
            "Les NROs ne peuvent être lancer que si Goldleaf est lancé en tant que NRO.",
            "Import de ticket",
            ...
            "Oui",
            "Non",
            "Oui, mais le compte utilisateur doit être lié au services Nintendo.",
            "Valeur inconnue",
            ...
            "Une erreur est survenue en tentant de supprimé le compte:",
            "libre",
            "Presse-papier",
