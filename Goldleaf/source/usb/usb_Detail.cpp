...
namespace usb::detail {
    ...
    namespace {
        ...
        bool g_usbCommsInitialized = false;
        usbCommsInterface g_usbCommsInterfaces[TotalInterfaces];
        bool g_usbCommsErrorHandling = 0;
        RwLock g_usbCommsLock;
        ...
        void _usbCommsInterfaceFree(usbCommsInterface *interface) {
