...
namespace gleaf::horizon
{
    ...
    bool ExportQlaunchRomFs()
    {
        ...
        bool ex = gleaf::hactool::Process(path, gleaf::hactool::Extraction::MakeRomFs("sdmc:/switch/goldleaf/qlaunch"), gleaf::hactool::ExtractionFormat::NCA, GetKeyFilePath());
        if(!ex) return ex;
        path = "qnand:/Contents/registered/" + gleaf::horizon::GetTitleNCAPath(0x0100000000001013);
        ex = gleaf::hactool::Process(path, gleaf::hactool::Extraction::MakeRomFs("sdmc:/switch/goldleaf/qlaunch"), gleaf::hactool::ExtractionFormat::NCA, GetKeyFilePath());
