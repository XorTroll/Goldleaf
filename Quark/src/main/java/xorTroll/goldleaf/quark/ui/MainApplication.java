    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Task<Void> usbtask = new Task<Void>() {
            ...
            protected Void call() throws Exception {
                ...
                if(usbInterface.productVersion.olderThan(MinimumGoldleafVersion)) {
                    showDialog("Outdated Goldleaf", "The Goldleaf Quark connected to is outdated.\nPlease update to v0.8 or higher.", "Ok", true);
                }
